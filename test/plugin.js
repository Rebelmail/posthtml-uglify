...
describe('HTMLUglify', function () {
  describe('#isWhitelisted', function () {
    ...
    beforeEach(function () {
      whitelist = ['#theid', '.theclass', '#★', '.★', /\.col-xs-.*/, /#main.+/];
    ...
    it('returns true if id is valid for a regular expression in whitelist', function () {
      var whitelisted = htmlUglify.isWhitelisted('id', 'main-div');
      assert.isTrue(whitelisted);
    });
    it('returns false if id is invalid for a regular expression in whitelist', function () {
      var whitelisted = htmlUglify.isWhitelisted('id', 'main');
      assert.isFalse(whitelisted);
    });
    it('returns true if class is valid for a regular expression in whitelist', function () {
      var whitelisted = htmlUglify.isWhitelisted('class', 'col-xs-12');
      assert.isTrue(whitelisted);
    });
    it('returns true if class is invalid for a regular expression in whitelist', function () {
      var whitelisted = htmlUglify.isWhitelisted('class', 'col-md-12');
      assert.isFalse(whitelisted);
    });
